...
const StartChat = ({navigation}) => {
  ...
  return (
    <PushDownAlertPortal
      config={{
        messageTextStyle: styles.notiMessage,
        titleTextStyle: styles.notiTitle,
      }}>
          ...
          <View style={{padding: 20}}>
            ...
            <View
              ...
              <Text>
                ...
                agreement between you and Xarp Spaces.{'\n'}
                ...
                communicate with others for lawful purposes only. You may not
                use the App to transmit, distribute, store, or otherwise make
                available content that is illegal, harmful, threatening,
                abusive, harassing, tortious, defamatory, vulgar, obscene,
                libelous, invasive of another's privacy, hateful, or racially,
                ethnically, or otherwise objectionable.{'\n'}Additionally, you
                may not use the App to harass, threaten, or abuse other users.
                Any behavior that is deemed to be abusive, including but not
                limited to bullying, threatening, and harassment, is strictly
                prohibited and may result in the immediate termination of your
                account.{'\n'}
                {'\n'}User Responsibility{'\n'}
                {'\n'}You are solely responsible for the content you transmit or
                otherwise make available through the App, including but not
                limited to any text, images, videos, or other materials. You
                agree to indemnify and hold harmless Xarp Spaces and its
                affiliates from any claims, damages, or expenses arising from
                your use of the App, including but not limited to your
                transmission of any objectionable content or abusive behavior.
                {'\n'}
                {'\n'}Proprietary Rights{'\n'}
                {'\n'}The App and its contents are protected by copyright,
                trademark, and other proprietary rights and laws. You agree not
                to modify, rent, lease, loan, sell, distribute, or create
                derivative works based on the App or any portion thereof, in any
                manner.
                {'\n'}
                {'\n'}Termination{'\n'}
                {'\n'}This Agreement is effective until terminated by either
                party. You may terminate this Agreement at any time by
                discontinuing use of the App. Xarp Spaces may also terminate
                this Agreement at any time and without notice, if in its sole
                discretion, you fail to comply with any term or provision of
                this Agreement.{'\n'}Upon termination, you must destroy all
                copies of the App in your possession.{'\n'}
                {'\n'}Disclaimer of Warranties{'\n'}
                {'\n'}The App is provided on an "as is" and "as available"
                basis. Xarp Spaces makes no representations or warranties of any
                kind, express or implied, as to the operation of the App or the
                information, content, materials, or products included on the
                App. You expressly agree that your use of the App is at your
                sole risk.
                {'\n'}
                {'\n'}
                ...
                you and Xarp Spaces regarding the use of the App. If any
                provision of this Agreement is found to be invalid, the
                remaining provisions shall remain in full force and effect.
                {'\n'}This Agreement shall be governed by the laws of the your
                of Jurisdiction and the parties agree to submit to the exclusive
                jurisdiction of the courts. Contact Information If you have any
                questions or concerns regarding this Agreement, please contact
                Xarp Spaces at xarpspaces@gmail.com.
              </Text>
            </View>
            <TouchableOpacity
              style={{
